...
enum class BlockKind { HlslProgram,
  HlslInclude,
  CgProgram,
  CgInclude,
  GlslProgram };
...
inline bool isCgBlock(BlockKind kind) {
  return kind == BlockKind::CgProgram || kind == BlockKind::CgInclude;
}
